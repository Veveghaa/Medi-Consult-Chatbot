...
if __name__ == "__main__":
    ...
    # if 1:
        ...
        if 'acne' in query:
            ...
            print('It is a swelling of appendix which is present in the large intestine.The main symptoms are severe pain in the abdomen region,diarrhoea and will feel sick.The treament method is only surgery,which may be an open surgery or laproscopy.')
            speak('It is a swelling of appendix which is present in the large intestine. The main symptoms are severe pain in the abdomen region, diarrhoea and  will feel sick. The treament method is only surgery, which may be an open surgery or  laproscopy.')
